...
const appCss = "/assets/styles-C-kQEjN2.css";
const faviconUrl = "/assets/logo-6oMvY4Bt.jpeg";
...
const logo = "/assets/logo-6oMvY4Bt.jpeg";
const links = [
  { to: "/", label: "Home" },
...
function Navbar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "header",
    {
      className: `fixed top-0 inset-x-0 z-50 transition-all duration-300 ${scrolled ? "py-3 backdrop-blur-xl bg-background/70 border-b border-border" : "py-5"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-6 flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-2.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: logo, alt: "Pixova", className: "h-9 w-9 rounded-md object-cover" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-semibold text-lg tracking-tight", children: "Pixova" })
          ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "lg:hidden p-2", onClick: () => setOpen(!open), "aria-label": "Menu", children: open ? /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "h-5 w-5" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Menu, { className: "h-5 w-5" }) })
          ] })
        ] }),
        open && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:hidden mt-3 mx-6 glass rounded-xl p-4 flex flex-col gap-2", children: links.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          Link,
          {
            to: l.to,
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "border-t border-border mt-32", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-6 py-16 grid grid-cols-2 md:grid-cols-5 gap-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-2.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: logo, alt: "Pixova", className: "h-10 w-10 rounded-md object-cover" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-semibold text-lg", children: "Pixova" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-sm text-muted-foreground max-w-xs", children: "Powering Small Businesses with Smart Technology." })
      ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(FooterCol, { title: "Services", links: [
        ["Web", "/services"],
        ["App", "/services"],
        ["AI", "/services"],
        ["Automation", "/services"],
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(FooterCol, { title: "Connect", links: [
        ["Contact", "/contact"],
        ["LinkedIn", "#"],
        ["GitHub", "#"]
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-6 py-6 flex flex-col sm:flex-row justify-between gap-3 text-xs text-muted-foreground", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "© 2025 Pixova. All Rights Reserved." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", className: "hover:text-foreground", children: "Privacy Policy" }),
...
function FooterCol({ title, links: links2 }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display text-sm font-semibold mb-4", children: title }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2.5", children: links2.map(([label, href]) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: href.startsWith("/") ? /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: href, className: "text-sm text-muted-foreground hover:text-foreground transition", children: label }) : /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href, className: "text-sm text-muted-foreground hover:text-foreground transition", children: label }) }, label)) })
  ] });
}
function openGraphImageUrl(assetHref) {
  return assetHref;
}
...
const $$splitComponentImporter$5 = () => import("./work-B4m6b0AX.js");
const Route$5 = createFileRoute("/work")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Real projects. Real results. Selected work by Pixova."
    }, {
      property: "og:title",
      content: "Work — Pixova"
    }, {
      property: "og:description",
      content: "Real projects. Real results."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./services-Bs3dK4Ih.js");
const Route$4 = createFileRoute("/services")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Web, app, AI, automation, and digital transformation services."
    }, {
      property: "og:title",
      content: "Services — Pixova"
    }, {
      property: "og:description",
      content: "Web, app, AI, automation, and digital transformation services."
    }]
...
const $$splitComponentImporter$3 = () => import("./process-D7Zvq3ns.js");
const Route$3 = createFileRoute("/process")({
  head: () => ({
    meta: [{
      title: "Process — Pixova"
    }, {
      name: "description",
      content: "From first message to final launch — here's exactly what working with us looks like."
    }, {
      property: "og:title",
      content: "Process — Pixova"
    }, {
      property: "og:description",
      content: "How Pixova works."
    }]
  }),
...
const $$splitComponentImporter$2 = () => import("./contact-Dp5mE8rU.js");
emailjs.init("CLl_fH30fB6hdv66Y");
...
const $$splitComponentImporter$1 = () => import("./about-nUuboUGr.js");
const Route$1 = createFileRoute("/about")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Pixova empowers small businesses with enterprise-grade tech."
    }, {
      property: "og:title",
      content: "About — Pixova"
    }, {
      property: "og:description",
      content: "Pixova empowers small businesses with enterprise-grade tech."
    }]
...
const $$splitComponentImporter = () => import("./index-B0nuxw7D.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Websites, apps, and AI-powered automations to help small businesses grow."
    }]
  }),
...
const ProcessRoute = Route$3.update({
  id: "/process",
  path: "/process",
  getParentRoute: () => Route$6
});
