...
function Section({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: id2, className: `py-24 md:py-32 ${className}`, children });
}
function FadeIn({
  children,
  delay: delay2 = 0,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    motion.div,
    {
      ...
      transition: { duration: 0.65, delay: delay2, ease: [0.22, 1, 0.36, 1] },
      className,
      children
    }
  );
}
function ShowcaseRowReveal({
  viewportNarrow,
  orderIndex,
  side,
  staggerSec,
  ...
  const slideX = reduceMotion ? side === "left" ? -14 : 14 : viewportNarrow ? side === "left" ? -48 : 48 : side === "left" ? -94 : 94;
...
function SectionLabel({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 px-3 py-1 rounded-full border border-border bg-card/50 text-xs uppercase tracking-widest text-muted-foreground", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "h-1.5 w-1.5 rounded-full bg-accent shadow-[0_0_10px_var(--accent)]" }),
    children
  ] });
}
export {
  ...
  motionValue as m,
  noop as n,
  useReducedMotion as o,
  progress as p,
  motion as q,
  resize as r,
  supportsViewTimeline as s,
  ShowcaseRowReveal as t,
  useConstant as u,
